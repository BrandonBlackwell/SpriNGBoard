...
// Game is only playable if there are 3 or more players
...
// 0,1,2,4,5,6,8,9,10 are used but not 3 and 7. Why? 
...
{
  // if the current player does not have 6 coins in their purse, they win.
